...
const JobDescription = () => {
    ...
    const jobId = params.id; //custom hook
    ...
    const applyJobHandler = async () => {
        try {
            ...
            if (res.data.success) {
                ...
                dispatch(setSingleJob(updateSingleJob)); // helps us to update real time
        ...
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                ...
                <Button
                    ...
                    disable={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#7209b7] hover:bg-[#5f32ad]'}`}>
